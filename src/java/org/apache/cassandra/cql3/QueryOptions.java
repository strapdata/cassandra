...
public abstract class QueryOptions
{
    ...
    {
        return new DefaultQueryOptions(consistency, values, false, new SpecificOptions(-1, null, serialConsistency, Long.MIN_VALUE, keyspace, Integer.MIN_VALUE), ProtocolVersion.V3);
    }
